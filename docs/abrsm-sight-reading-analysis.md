...
| 4 ✅ | ＋**6/8**（首次出現複拍子） | 6–8 |
| 5 ⚠️ | 同上 | **8–12** |
| 6 ⚠️ | ＋9/8, 12/8, 2/2, **5/4**；**允許變換拍號（脈動不變）** | 10–14 |
| 7 ⚠️ | ＋5/8, 7/8, 7/4 | 12–16 |
| 8 ⚠️ | ＋7/4（7/8 已於 Grade 7 出現） | 12–16 |
...
1. **Grade 6–8 的調性上限**——目前仍是依演進推估（5/6/6 個升降記號），這次核對沒有逐題數過每題的調號
2. **Grade 6–8 的小節數範圍**——Grade 1–5 已用範例本核對（Grade 2 已修正為固定值，見 2.2 節）；Grade 6–8 的 10–14／12–16 小節仍是推估，範例本裡實際數起來多半落在較短的一端，值得之後更仔細地逐題計算
3. **Grade 6 變換拍號的具體允許組合**——已確認「脈動不變」這個限制，但未確認允許哪些拍號對；範例本裡這次也沒有觀察到實際換拍號的例子
4. **Grade 7 裝飾音的種類範圍**——範例本裡 Grade 7 沒有觀察到明確的裝飾音記號；反而 Grade 8（AB3401）出現了 mordent（不只 acciaccatura），值得之後確認 mordent 是從哪一級開始出現
